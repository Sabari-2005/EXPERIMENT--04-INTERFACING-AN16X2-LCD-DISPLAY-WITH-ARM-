...
9. 9. Add necessary library files of LCD 16x2 , write the program and use project and build  
...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Sabarinath.R\n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223100048\n");
...
## Output screen shots of proteus  :
 ![Screenshot 2024-09-23 090916](https://github.com/user-attachments/assets/ac957932-c292-4079-b92b-60ef9136b578)

  ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-09-23 090831](https://github.com/user-attachments/assets/6c3517e8-4597-4f6a-a078-fbef02535cef)
